...
export const ProspectorsDrill = new DbObjectWeapon({
    name: 'prospectors_drill',
    serializeId: 160,
    gameId: 13427,
    iconClass: 'weapon-icon-polearm-prospectors-drill',
    rarity: 4,
    weapon: 'polearm',
    statTable: weaponStatTables.ProspectorsDrill,
    conditions: [
        new ConditionStacks({
